...
win.title("Ping-Pong Game - Satwik") # Giving name to the game.
...
while True:
    ...
    if ball.xcor() > 390:   # right width paddle Border
        ...
        pen.clear()
        pen.write("Player A: {}                    Player B: {} ".format(player_b_score,player_a_score),align="center",font=('Monaco',24,"normal"))
